...
for 64-bit environment:
  ...
  * `mariadb-10.1.17-with-mroonga-6.10-win32.zip <https://github.com/mroonga/mroonga/releases/download/v6.10/mariadb-10.1.17-with-mroonga-6.10-win32.zip>`_
  * `mariadb-10.1.17-with-mroonga-6.10-winx64.zip <https://github.com/mroonga/mroonga/releases/download/v6.10/mariadb-10.1.17-with-mroonga-6.10-winx64.zip>`_
