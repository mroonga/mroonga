...
for 64-bit environment:
  ...
  * `mariadb-10.1.19-with-mroonga-6.12-win32.zip <https://github.com/mroonga/mroonga/releases/download/v6.12/mariadb-10.1.19-with-mroonga-6.12-win32.zip>`_
  * `mariadb-10.1.19-with-mroonga-6.12-winx64.zip <https://github.com/mroonga/mroonga/releases/download/v6.12/mariadb-10.1.19-with-mroonga-6.12-winx64.zip>`_
