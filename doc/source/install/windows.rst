...
for 64-bit environment:
  ...
  * `mariadb-10.0.20-with-mroonga-5.06-win32.zip <https://github.com/mroonga/mroonga/releases/download/v5.06/mariadb-10.0.21-with-mroonga-5.06-win32.zip>`_
  * `mariadb-10.0.20-with-mroonga-5.06-winx64.zip <https://github.com/mroonga/mroonga/releases/download/v5.06/mariadb-10.0.21-with-mroonga-5.06-winx64.zip>`_
