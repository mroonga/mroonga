...
for 64-bit environment:
  ...
  * `mariadb-10.0.16-with-mroonga-5.00-win32.zip <https://github.com/mroonga/mroonga/releases/download/v5.00/mariadb-10.0.16-with-mroonga-5.00-win32.zip>`_
  * `mariadb-10.0.16-with-mroonga-5.00-winx64.zip <https://github.com/mroonga/mroonga/releases/download/v5.00/mariadb-10.0.16-with-mroonga-5.00-winx64.zip>`_
