...
for 64-bit environment:
  ...
  * `mariadb-10.1.21-with-mroonga-7.01-win32.zip <https://github.com/mroonga/mroonga/releases/download/v7.01/mariadb-10.1.21-with-mroonga-7.01-win32.zip>`_
  * `mariadb-10.1.21-with-mroonga-7.01-winx64.zip <https://github.com/mroonga/mroonga/releases/download/v7.01/mariadb-10.1.21-with-mroonga-7.01-winx64.zip>`_
