...
for 64-bit environment:
  ...
  * `mariadb-10.0.15-with-mroonga-4.08-win32.zip <https://github.com/mroonga/mroonga/releases/download/v4.08/mariadb-10.0.15-with-mroonga-4.08-win32.zip>`_
  * `mariadb-10.0.15-with-mroonga-4.08-winx64.zip <https://github.com/mroonga/mroonga/releases/download/v4.08/mariadb-10.0.15-with-mroonga-4.08-winx64.zip>`_
