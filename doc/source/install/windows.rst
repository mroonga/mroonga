...
for 64-bit environment:
  ...
  * `mariadb-10.0.16-with-mroonga-4.10-win32.zip <https://github.com/mroonga/mroonga/releases/download/v4.10/mariadb-10.0.16-with-mroonga-4.10-win32.zip>`_
  * `mariadb-10.0.16-with-mroonga-4.10-winx64.zip <https://github.com/mroonga/mroonga/releases/download/v4.10/mariadb-10.0.16-with-mroonga-4.10-winx64.zip>`_
