...
for 64-bit environment:
  ...
  * `mariadb-10.1.8-with-mroonga-5.10-win32.zip <https://github.com/mroonga/mroonga/releases/download/v5.10/mariadb-10.1.8-with-mroonga-5.10-win32.zip>`_
  * `mariadb-10.1.8-with-mroonga-5.10-winx64.zip <https://github.com/mroonga/mroonga/releases/download/v5.10/mariadb-10.1.8-with-mroonga-5.10-winx64.zip>`_
