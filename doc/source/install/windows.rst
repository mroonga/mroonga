...
for 64-bit environment:
  ...
  * `mariadb-10.0.17-with-mroonga-5.03-win32.zip <https://github.com/mroonga/mroonga/releases/download/v5.03/mariadb-10.0.17-with-mroonga-5.03-win32.zip>`_
  * `mariadb-10.0.17-with-mroonga-5.03-winx64.zip <https://github.com/mroonga/mroonga/releases/download/v5.03/mariadb-10.0.17-with-mroonga-5.03-winx64.zip>`_
