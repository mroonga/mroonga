...
for 64-bit environment:
  ...
  * `mariadb-10.0.17-with-mroonga-5.01-win32.zip <https://github.com/mroonga/mroonga/releases/download/v5.01/mariadb-10.0.17-with-mroonga-5.01-win32.zip>`_
  * `mariadb-10.0.17-with-mroonga-5.01-winx64.zip <https://github.com/mroonga/mroonga/releases/download/v5.01/mariadb-10.0.17-with-mroonga-5.01-winx64.zip>`_
