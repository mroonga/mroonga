...
for 64-bit environment:
  ...
  * `mariadb-10.0.19-with-mroonga-5.04-win32.zip <https://github.com/mroonga/mroonga/releases/download/v5.04/mariadb-10.0.19-with-mroonga-5.04-win32.zip>`_
  * `mariadb-10.0.19-with-mroonga-5.04-winx64.zip <https://github.com/mroonga/mroonga/releases/download/v5.04/mariadb-10.0.19-with-mroonga-5.04-winx64.zip>`_
