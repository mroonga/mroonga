...
for 64-bit environment:
  ...
  * `mariadb-10.0.21-with-mroonga-5.09-win32.zip <https://github.com/mroonga/mroonga/releases/download/v5.09/mariadb-10.0.21-with-mroonga-5.09-win32.zip>`_
  * `mariadb-10.0.21-with-mroonga-5.09-winx64.zip <https://github.com/mroonga/mroonga/releases/download/v5.09/mariadb-10.0.21-with-mroonga-5.09-winx64.zip>`_
