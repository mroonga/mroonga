...
for 64-bit environment:
  ...
  * `mariadb-10.0.12-with-mroonga-4.05-win32.zip <https://github.com/mroonga/mroonga/releases/download/v4.05/mariadb-10.0.12-with-mroonga-4.05-win32.zip>`_
  * `mariadb-10.0.12-with-mroonga-4.05-winx64.zip <https://github.com/mroonga/mroonga/releases/download/v4.05/mariadb-10.0.12-with-mroonga-4.05-winx64.zip>`_
