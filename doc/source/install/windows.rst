...
for 64-bit environment:
  ...
  * `mariadb-10.1.14-with-mroonga-6.09-win32.zip <https://github.com/mroonga/mroonga/releases/download/v6.09/mariadb-10.1.14-with-mroonga-6.09-win32.zip>`_
  * `mariadb-10.1.14-with-mroonga-6.09-winx64.zip <https://github.com/mroonga/mroonga/releases/download/v6.09/mariadb-10.1.14-with-mroonga-6.09-winx64.zip>`_
