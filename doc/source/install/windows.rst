...
for 64-bit environment:
  ...
  * `mariadb-10.1.13-with-mroonga-6.01-win32.zip <https://github.com/mroonga/mroonga/releases/download/v6.01/mariadb-10.1.13-with-mroonga-6.01-win32.zip>`_
  * `mariadb-10.1.13-with-mroonga-6.01-winx64.zip <https://github.com/mroonga/mroonga/releases/download/v6.01/mariadb-10.1.13-with-mroonga-6.01-winx64.zip>`_
