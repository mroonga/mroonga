...
for 64-bit environment:
  ...
  * `mariadb-10.1.30-with-mroonga-7.11-win32.zip <https://github.com/mroonga/mroonga/releases/download/v7.11/mariadb-10.1.30-with-mroonga-7.11-win32.zip>`_
  * `mariadb-10.1.30-with-mroonga-7.11-winx64.zip <https://github.com/mroonga/mroonga/releases/download/v7.11/mariadb-10.1.30-with-mroonga-7.11-winx64.zip>`_
