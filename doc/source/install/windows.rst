...
for 64-bit environment:
  ...
  * `mariadb-10.0.15-with-mroonga-4.09-win32.zip <https://github.com/mroonga/mroonga/releases/download/v4.09/mariadb-10.0.15-with-mroonga-4.09-win32.zip>`_
  * `mariadb-10.0.15-with-mroonga-4.09-winx64.zip <https://github.com/mroonga/mroonga/releases/download/v4.09/mariadb-10.0.15-with-mroonga-4.09-winx64.zip>`_
