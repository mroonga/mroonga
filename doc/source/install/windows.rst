...
for 64-bit environment:
  ...
  * `mariadb-10.1.30-with-mroonga-8.00-win32.zip <https://github.com/mroonga/mroonga/releases/download/v8.00/mariadb-10.1.30-with-mroonga-8.00-win32.zip>`_
  * `mariadb-10.1.30-with-mroonga-8.00-winx64.zip <https://github.com/mroonga/mroonga/releases/download/v8.00/mariadb-10.1.30-with-mroonga-8.00-winx64.zip>`_
