...
(release-14-14)=
## Release 14.14 - 2025-01-30

### Fixes

#### Fixed a bug that Mroonga packages use a previous version of Goonga
...
However, Mroonga 14.13 use Groonga 14.1.2 not 14.1.3.

So, we suggest that use Mroonga 14.14 instead of 14.13.
