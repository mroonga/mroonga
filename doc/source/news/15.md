...
### Added support for the following new MariaDB and MySQL version

* MySQL Community Server 8.4 on AlmaLinux 10.
* MariaDB 11.8 on AlmaLinux 8.
* MariaDB 11.8 on AlmaLinux 9.
* MariaDB 11.8 on Debian 13 (trixie).
