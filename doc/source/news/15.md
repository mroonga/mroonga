...
### Added support for MariaDB 10.11.16 in the following OSes.

* AlmaLinux 8, 9

10.11.16 is the latest MariaDB 10.11 release.

### Added support for MariaDB 11.4.10 in the following OSes.

* AlmaLinux 8, 9

11.4.10 is the latest MariaDB 11.4 release.
