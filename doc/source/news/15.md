...
### Added new support for MariaDB 11.8 in the following OSes.

* AlmaLinux 8.
* AlmaLinux 9.
* Debian 13 (trixie).

### Added support for MySQL Community Server 8.0.44 in the following OSes.
...
### Added support for MySQL Community Server 8.4.7 in the following OSes.
...
### Added support for MariaDB 10.6.24 in the following OSes.

* AlmaLinux 8, 9

10.6.24 is the latest MariaDB 10.6 release.

### Added support for MariaDB 10.11.15 in the following OSes.

* AlmaLinux 8, 9

10.11.15 is the latest MariaDB 10.11 release.

### Added support for MariaDB 11.4.9 in the following OSes.

* AlmaLinux 8, 9

11.4.9 is the latest MariaDB 11.4 release.

### Added support for Percona Server for MySQL 8.0.44-35 in the following OSes.
