...
8.0.44 is the latest MySQL Community Server 8.0 relase.
...
8.4.7 is the latest MySQL Community Server 8.4 relase.

### Added support for MySQL Community Server minimal 8.0.44 in the following OS.

* AlmaLinux 9

8.0.44 is the latest MySQL Community Server minimal 8.0 relase.

### Added support for MySQL Community Server minimal 8.4.8 in the following OS.

* AlmaLinux 9

8.4.8 is the latest MySQL Community Server minimal 8.4 relase.
